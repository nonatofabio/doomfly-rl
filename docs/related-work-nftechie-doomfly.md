...
| **Results posture** | Ships checkpoints + eval videos. `malecns49k_v2_final` (= `g6-12xl-use2-v2/runs/malecns49k/final`), mean return over 10 episodes: basic 78.2, defend_the_center 18.1, health_gathering 1817.6, deadly_corridor 2280.1, defend_the_line 22.7 | Ships negative results: v6 candidate failed visual‑recovery, conditioning, and survival gates; labelled UNVALIDATED; "not demonstrated learned survival"; sim runs at 0.158× wall time |
